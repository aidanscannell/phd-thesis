...
3. Build a =pdf= file [[phd-thesis.pdf]] from the =TeX= file [[phd-thesis.tex]], my =BibTeX= file [[zotero-library.bib]], the images in [[images/]] and the =LaTeX= template files in [[mimosis-class,]]
