...
cref:chap-traj-opt-control are evaluated on a simulated version
...
Environment 1.
Further to this, the region no observations does not overlap the mode boundary like in Environment 1.
...
This performance of the trajectory optimisation algorithms in the simulated environments are evaluated
...
is measured using the probability of remaining in the desired dynamics mode cref:eq-mode-probability-all-unc.
The secondary goals of avoiding regions of the learned dynamics model with high epistemic uncertainty
...
uncertainty (Goal 3.2), is measured by summing the gating function variance cref:eq-metric-gating-var over each
trajectory.
...
|     |                 |           | cref:eq-mode-probability-no-unc | cref:eq-mode-probability-all-unc | $\mathbb{V}[\stateTraj]$ | $\mathbb{V}[\gatingFunc_{\desiredMode}(\stateTraj)]$ | cref:eq-approximate-trajectory-riemannian-energy | $\state_{\TimeInd}==\targetState$? |
|-----+-----------------+-----------+---------------------------------+----------------------------------+--------------------------+------------------------------------------------------+--------------------------------------------------+------------------------------------|
|     | \ig             | $0.5$     | $16.96$                         | $16.22$                          | $8.69$                   | $346.62$                                             | $238.29$                                         | $\times$ dynamics only             |
|     | \ig             | $1.0$     | $18.51$                         | $16.98$                          | $8.70$                   | $367.16$                                             | $222.07$                                         | $\times$ dynamics only             |
|     | \ig             | $20.0$    | $15.32$                         | $14.62$                          | $\mathbf{8.66}$          | $201.45$                                             | $627.74$                                         | $\times$ dynamics only             |
...
|     | \dre            | $20.0$    | $12.64$                         | $13.00$                          | $8.69$                   | $\mathbf{157.83}$                                    | $349.08$                                         | $\times$ dynamics only             |
...
The control-as-inference method in cref:sec-traj-opt-inference was tested with and without maximum entropy behaviour,
