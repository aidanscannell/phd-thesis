...
**** Gating
***** Variables
#+LATEX_HEADER: \newcommand{\uh}{\ensuremath{v}}
#+LATEX_HEADER: \newcommand{\uHk}{\ensuremath{\Mk{\mathbf{\uh}}}}
#+LATEX_HEADER: \newcommand{\uH}{\ensuremath{\MakeUppercase{\mathbf{\uh}}}}
...
Each mode's output dimensions are assumed independent,
#+BEGIN_EXPORT latex
\begin{align} \label{eq-single-expert-prior}
\pFk &= \prod_{\stateDim=1}^{\StateDim} \pFkd.
\end{align}
...
#+END_EXPORT
Instead of collapsing the inducing variables here cite:titsiasVariational2009
