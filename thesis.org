...
Well-calibrated uncertainty estimates and scalability are obtained via a
...
Given the learned dynamics model, this dissertation develops two such trajectory optimisation algorithms.
The first approach
