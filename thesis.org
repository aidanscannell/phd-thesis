...
Eq. ref:eq-output-space-entropy.
...
has been exploited.
The first term in Eq. ref:eq-output-space-entropy is approximated as follows,
#+BEGIN_EXPORT latex
...
The objective in Eq. ref:eq-output-space-entropy can then be approximated as,
#+BEGIN_EXPORT latex
