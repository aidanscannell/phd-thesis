...
*Policy learning*
Another interesting direction for future work is to explore learning a state feedback policy for the explorative
controller using policy search.
For example, the trajectory optimisation algorithm could be used for guided policy search cite:levineGuided2013.
It should also be straightforward to check that trajectories under a feedback
...
* Conclusion
A central objective of this dissertation
** Future Work
